        ...
        <div className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold font-display animate-on-scroll bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">{t('brochures.title')}</h1>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a
                          ...
                          download
                          className="mt-4 inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary to-secondary hover:from-primary/80 hover:to-secondary/80 text-white font-medium rounded-md shadow-lg shadow-primary/20 transition-all duration-300"
                        >
            ...
            <div className="max-w-md mx-auto glass-panel p-8 md:p-12 rounded-xl animate-on-scroll" style={{ transitionDelay: '200ms' }}>
              <h2 className="text-2xl font-bold font-display mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">{t('brochures.requestFormTitle', 'Request More Information')}</h2>
              <form className="space-y-6">
                ...
                <div className="text-center pt-2">
                  <button
                    type="submit"
                    className="w-full px-8 py-3 bg-gradient-to-r from-primary to-secondary hover:from-primary/80 hover:to-secondary/80 text-white font-bold rounded-md shadow-lg shadow-primary/20 transition-all duration-300"
                  >
