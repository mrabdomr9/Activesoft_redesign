        ...
        <div className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h1 className="text-4xl font-bold font-display animate-on-scroll bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">{t('industries.title')}</h1>
              ...
              {industriesData.map((industry, index) => (
                <div key={industry.key} className="grid md:grid-cols-2 gap-12 items-stretch glass-panel p-8 md:p-12 rounded-xl animate-on-scroll">
                  ...
                  <div className="flex flex-col">
                    <h2 className="text-3xl font-bold text-primary mb-4 font-display">{t(`industries.${industry.key}.name`)}</h2>
