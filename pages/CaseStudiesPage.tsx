        ...
        <div className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold font-display animate-on-scroll bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">{pageTitle}</h1>
              ...
              {filteredStudies.map((study, index) => (
                <div key={index} className="glass-panel rounded-xl overflow-hidden md:flex animate-on-scroll">
                  ...
                  <div className="p-8 md:w-2/3">
                    <p className="text-sm font-semibold text-primary uppercase font-display tracking-widest">{study.industry}</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <h3 className="font-bold text-primary">The Result:</h3>
